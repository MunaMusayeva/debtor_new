...
class Proqram
{
    ...
    static void Main(string[] args)
    {
        ...
        //db.ForEach(debtors => Console.WriteLine(debtors));
        //13
        //var db = debtors.GroupBy(d => d.Birthday.Year).OrderByDescending(g => g.Count()).First().Key;
        //Console.WriteLine(db);
        //11
        //var db = debtors.Where(b => b.Fullname.GroupBy(c => c).Any(g => g.Count() >= 3)).OrderBy(b => b.Fullname).ToList();
        //db.ForEach(debtors => Console.WriteLine(debtors));
        //18
